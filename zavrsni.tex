...
\begin{lstlisting}[caption=Zahtjev klijenta tijekom rukovanja]
GET /chat HTTP/1.1
...
\begin{lstlisting}[caption=Odgovor poslužitelja tijekom rukovanja]
...
\begin{figure}[htb]
\centering
\includegraphics[width=8cm]{img/fcm.png}
...
\begin{lstlisting}[caption=JSON objekt za ``tihu'' dojavu, label=lst:tiha-dojava, float]
{
    "aps" : {
        "content-available" : 1
    }
